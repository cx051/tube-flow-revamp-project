...
const SearchBar: React.FC<SearchBarProps> = ({ onSearch, onSettingsOpen }) => {
    ...
    <div className="relative w-full max-w-3xl mx-auto">
      <div className="relative flex items-center bg-gray-800 rounded-lg overflow-hidden shadow-lg focus-within:ring-2 focus-within:ring-purple-500 transition-all">
        ...
        {query && (
          <button 
            onClick={clearSearch}
            className="mx-1 p-1 rounded-full hover:bg-gray-700 text-gray-400"
          >
            <X size={16} />
          </button>
        )}
        ...
        <button 
          ...
          className="bg-purple-600 hover:bg-purple-700 text-white py-3 px-5 transition-colors"
        >
          Search
        </button>
        ...
        <button 
          ...
          className="p-3 text-gray-400 hover:bg-gray-700 transition-colors"
        >
          <Settings size={20} />
        </button>
      </div>
      ...
      <AnimatedTransition show={showHistory && searchHistory.length > 0} type="fade" direction="down">
        <div 
          ref={historyRef}
          className="absolute w-full mt-2 bg-gray-800 rounded-lg shadow-lg overflow-hidden z-50"
        >
